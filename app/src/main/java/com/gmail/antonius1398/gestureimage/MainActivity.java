package com.gmail.antonius1398.gestureimage;
...
public class MainActivity extends Activity implements OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView tampilGambar = (ImageView)findViewById(R.id.qq);
            ...
            case MotionEvent.ACTION_MOVE:
                if (mode == DRAG) {
                    ...
                    if (jarakBaru > 10f) {
                        ...
                        matrix.postScale(scale, scale, tengah.x, tengah.y);
                    }
